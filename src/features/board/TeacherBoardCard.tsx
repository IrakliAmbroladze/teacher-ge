...
export const TeacherBoardCard = ({ name, img_url }: TeacherBoardCardProps) => {
  return (
    <div className="p-[20px] w-[150px] h-[200px] flex flex-col items-center rounded-md shadow-2xl cursor-pointer hover:scale-105 transition-transform duration-150 ease-in-out dark:shadow-stone-800/80">
